...
// Isso permite que o aplicativo seja carregado mais rapidamente nas visitas subsequentes na produção e fornece
...
      // serve ativos; consulte https://github.com/facebook/create-react-app/issues/2374
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        // Isso está sendo executado no localhost. Vamos verificar se um trabalhador de serviço ainda existe ou não.
